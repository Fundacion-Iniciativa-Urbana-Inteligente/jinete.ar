...
const UnlockDevice = () => {
  const {
    accessToken,
    deviceLocation
  } = useLocation(); // Obtener accessToken y deviceLocation desde el contexto
  ...
  }, /*#__PURE__*/React.createElement("h2", null, "Desbloquear Bicicleta"), /*#__PURE__*/React.createElement("input", {
    type: "text",
  ...
  }, isProcessing ? "Procesando..." : "Abrir Candado"), responseMessage && success && /*#__PURE__*/React.createElement("p", {
    style: {
      color: "green",
      marginTop: "20px"
    }
  }, responseMessage), error && /*#__PURE__*/React.createElement("p", {
    style: {
      color: "red",
      marginTop: "20px"
    }
